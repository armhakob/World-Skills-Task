...
class OpeningTicketAdapter(private val context: Context, private val items: MutableList<Ticket>, val onClick: (item: Ticket) -> Unit) :
    ...
    override fun getItemViewType(position: Int): Int {
        return when (items[position]) {
            is Ticket -> {
                if (items[position].type == "Opening") VIEW_TYPE_HEADER
    ...
    fun getUpdatedList(): MutableList<Ticket> = items
}